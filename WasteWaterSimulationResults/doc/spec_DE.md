Entität: WasteWaterSimulationResults  
====================================  
[Offene Lizenz](https://github.com/smart-data-models//dataModel.WasteWater/blob/master/WasteWaterSimulationResults/LICENSE.md)  
...
#### WasteWaterSimulationResults NGSI-v2 key-values Beispiel  
Hier ist ein Beispiel für ein WasteWaterSimulationResults im JSON-LD-Format als Key-Values. Dies ist kompatibel mit NGSI-v2, wenn `options=keyValues` verwendet wird und liefert die Kontextdaten einer einzelnen Entität.  
...
```  
#### WasteWaterSimulationResults NGSI-v2 normalized Beispiel  
Hier ist ein Beispiel für ein WasteWaterSimulationResults im JSON-LD-Format in normalisierter Form. Dies ist kompatibel mit NGSI-v2, wenn keine Optionen verwendet werden, und liefert die Kontextdaten einer einzelnen Entität.  
...
```  
#### WasteWaterSimulationResults NGSI-LD key-values Beispiel  
Hier ist ein Beispiel für ein WasteWaterSimulationResults im JSON-LD-Format als Key-Values. Dies ist kompatibel mit NGSI-LD, wenn `options=keyValues` verwendet wird und liefert die Kontextdaten einer einzelnen Entität.  
...
```  
#### WasteWaterSimulationResults NGSI-LD normalized Beispiel  
Hier ist ein Beispiel für ein WasteWaterSimulationResults im JSON-LD-Format in normalisierter Form. Dies ist kompatibel mit NGSI-LD, wenn keine Optionen verwendet werden, und liefert die Kontextdaten einer einzelnen Entität.  
