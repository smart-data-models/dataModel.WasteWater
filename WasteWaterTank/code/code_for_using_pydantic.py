...
class Airflow(BaseModel):
    estimated: Optional[float] = Field(None, description='Airflow estimated by a model')
    measured: Optional[float] = Field(None, description='Airflow measured by a device')
...
class Power(BaseModel):
    estimated: Optional[float] = Field(None, description='Power estimated by a model')
    measured: Optional[float] = Field(None, description='Power measured by a device')


class Type6(Enum):
    WasteWaterTank = 'WasteWaterTank'


class WasteWaterTank(BaseModel):
    address: Optional[Address] = Field(None, description='The mailing address')
    airflow: Optional[Airflow] = Field(
        None, description='Object defining the actual and estimated airflow'
    )
    ...
    power: Optional[Power] = Field(
        None, description='Object defining the actual and estimated power consumption'
    )
    ...
    sludgeLevel: Optional[float] = Field(
        None, description='Sludge Level measured in a secondary settler tank'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI-LD Entity Type. It has to be WasteWaterTank'
    )
