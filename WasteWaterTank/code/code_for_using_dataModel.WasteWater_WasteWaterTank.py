...
dataModel = "WasteWaterTank"
subject = "dataModel.WasteWater"
do = {'type': 'Property', 'value': 1.2}
attribute = "do"
value = do
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

endsAt = "{'type': 'Relationship', 'object': 'urn:ngsi-ld:WasteWaterTank:secondarySettler2a'}"
attribute = "endsAt"
value = endsAt
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

nh4 = {'type': 'Property', 'value': 1.3}
attribute = "nh4"
value = nh4
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

no3 = {'type': 'Property', 'value': 5.2}
attribute = "no3"
value = no3
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))
